                    ...
                    >
                        ...
                        <View style={styles.card}>
                            <CustomDropdown
                                ...
                                onSelect={(val) =>
                                    setForm({ ...form, spendingPreference: val })
                                }
                                theme={theme}
                            ...
                            <CustomDropdown
                                ...
                                onSelect={(val) =>
                                    setForm({ ...form, securityQuestion: val })
                                }
                                theme={theme}
                            ...
                            <CustomInput
                                ...
                                onChangeText={(text) =>
                                    setForm({ ...form, securityAnswer: text })
                                }
                                theme={theme}
